...
public class PendentesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.activity_pendentes));
        ...
        //runOnUiThread(new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PedidoView pedido = PedidoController.getInstance(context)
                        .obterPedidosPorStatusDB(new String[]{"Pendente"}, DadosUsuarioLogado.getTecnico().getIdTecnico());
