...
public class FinalizadosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.activity_finalizados));
...
//                        .obterPedidosPorStatus("Finalizado", "65386");

                PedidoView pedido = PedidoController.getInstance(context)
                        .obterPedidosPorStatusDB(new String[]{"Finalizado"}, DadosUsuarioLogado.getTecnico().getIdTecnico());
