...
public class CanceladosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.activity_cancelados));
...
//                        .obterPedidosPorStatus("Cancelado", "65386");

                PedidoView pedido = PedidoController.getInstance(context)
                        .obterPedidosPorStatusDB( new String[]{"Cancelado"}, DadosUsuarioLogado.getTecnico().getIdTecnico());
